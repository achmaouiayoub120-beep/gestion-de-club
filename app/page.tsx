...
const Footer = () => {
  return (
    <footer className="bg-primary text-primary-foreground mt-12 py-8 border-t border-primary/20">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <h3 className="font-bold text-lg mb-2">EST Club Management</h3>
            <p className="text-sm opacity-90">Système de Gestion des Clubs Scolaires</p>
          </div>
          <div>
            <h3 className="font-bold text-lg mb-2">À Propos</h3>
            <p className="text-sm opacity-90">
              Plateforme dédiée à la gestion des adhérents, activités et cotisations - EST
            </p>
          </div>
        </div>
        <div className="border-t border-primary/20 mt-6 pt-6 text-center text-xs opacity-75">
          <p>&copy; {new Date().getFullYear()} EST Club Management System. Tous droits réservés.</p>
        </div>
      </div>
    </footer>
  )
...
export default function Dashboard() {
  ...
  const initializeSampleData = () => {
    const sampleEntraineurs: Entraineur[] = [
      {
        ...
        nom: "El Idrissi",
        prenom: "Rachid",
        specialite: "Superviseur Senior",
        email: "rachid.elidrissi@est.ma",
      ...
      },
      {
        ...
        nom: "El Hanafi",
        prenom: "Yassine",
        specialite: "Superviseur Formation",
        email: "yassine.elhanafi@est.ma",
      ...
      },
      {
        ...
        nom: "Boutaina",
        prenom: "Hajar",
        specialite: "Superviseur Activités",
        email: "hajar.boutaina@est.ma",
    ...
    const sampleActivites: Activite[] = [
      {
        id: "1",
        nom: "Atelier de Développement - Équipe Senior",
        description: "Atelier de formation et développement à Campus EST",
        entraineurId: "1",
      ...
      {
        id: "2",
        nom: "Séminaire Technique - Leadership & Communication",
        description: "Séminaire technique au Centre de Formation EST",
        entraineurId: "2",
      ...
      {
        id: "3",
        nom: "Conférence Club - Réunion des Membres",
        description: "Conférence et réunion générale au Campus EST",
        entraineurId: "3",
    ...
    <div className="flex flex-col min-h-screen bg-background text-foreground">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="w-20 h-20 flex items-center justify-center">
                <img src="/est-logo-circle.png" alt="EST Club Management Logo" className="w-full h-full object-contain" />
              </div>
              <div>
                <h1 className="text-4xl font-bold">EST Club Management</h1>
                <p className="text-sm mt-1 opacity-90">Système de Gestion des Clubs - EST</p>
              </div>
            </div>
            <Button
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-card rounded-lg shadow-md p-6 border border-border">
                ...
                <div className="space-y-3">
                  <div>
                    <p className="text-sm text-muted-foreground">Pourcentage de membres actifs</p>
          ...
          <div className="bg-card rounded-lg shadow">
            <div className="flex justify-between items-center p-6 border-b border-border">
              ...
              <div className="flex gap-3">
                ...
                >
                  <Filter size={20} />
                  {filterRACOnly ? "Membres Actifs" : "Tous"}
                </button>
                <button
              ...
              <table className="w-full">
                <thead className="bg-muted">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-left text-sm font-semibold">Membre Actif</th>
        ...
        {activeTab === "activites" && (
          <div className="bg-card rounded-lg shadow">
            <div className="flex justify-between items-center p-6 border-b border-border">
              <h2 className="text-2xl font-bold">Activités EST</h2>
              <button
        ...
        {activeTab === "entraineurs" && (
          <div className="bg-card rounded-lg shadow">
            <div className="flex justify-between items-center p-6 border-b border-border">
              <h2 className="text-2xl font-bold">Superviseurs EST</h2>
              <button
